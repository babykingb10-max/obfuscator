...
export default function Sidebar({ activeView, onNavigate, vaultCount = 0 }: SidebarProps) {
          ...
          {NAV_ITEMS.map(({ key, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                ...
                {key === "history" && vaultCount > 0 && (
                  <span className="text-[10px] font-mono px-1.5 py-0.5 rounded-full bg-charcoal-700 text-slate-400">
                    {vaultCount}
                  </span>
                )}
              </button>
